...
public class Assistant
{
    ...
    public static Set<Vertex> DFS(Graph graph, Set<Vertex> toVisit)
    {
        return toVisit;
    }
    ...
    public static int TOTAL_CUT_VERTICES(Graph graph)
    {
        ...
        for(Vertex vertex : graph.getAllVertices())
        {
            ...
            if(components < Assistant.TOTAL_COMPONENTS(graph)) i++;
    ...
    public static double DO_All(Edge edge, double x3, double y3)
    {
        double m = SLOPE(edge);
