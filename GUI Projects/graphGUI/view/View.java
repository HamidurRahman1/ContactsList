...
public class View extends Application
{
    ...
    private RadioButton shortestPath;
    ...
    private VBox setLeftSide()
    {
        ...
        shortestPath.setToggleGroup(toggleGroup);
        shortestPath.setStyle(CommonStyle.RadioButtonCSS());
        shortestPath.setOnAction(e -> controller.shortestPath());
        ...
        bfs.setStyle(CommonStyle.ButtonCSS());
        bfs.setOnAction(e -> controller.doBFS());
    
        Button dfs = new Button("DFS");
        dfs.setStyle(CommonStyle.ButtonCSS());
        dfs.setOnAction(e -> controller.doDFS());
        ...
        mst.setStyle(CommonStyle.ButtonCSS());
        mst.setOnAction(e -> controller.mst());
        ...
        vBox.getChildren().add(new Separator());
        vBox.getChildren().add(shortestPath);
        
        vBox.getChildren().add(separatorLabel(string));
        ...
        vBox.getChildren().add(bfs);
        vBox.getChildren().add(new Separator());
        vBox.getChildren().add(dfs);
        vBox.getChildren().add(new Separator());
        vBox.getChildren().add(mst);
    ...
    public RadioButton getShortestPath()
    {
        return shortestPath;
    }
