...
//            throw ex;
    ...
    public Map<Word, Integer> insertWords(Set<Word> words) throws SQLIntegrityConstraintViolationException, SQLException
    {
        final String sql = "insert into Words (word) values (?)";
...
//            throw ex;
    ...
    public Set<Word> insertWordsSet(Set<Word> words) throws SQLIntegrityConstraintViolationException, SQLException
    {
        final String sql = "insert into Words (word) values (?)";
...
//            throw ex;
    ...
    public Word getWordObjByWord(String word) throws SQLException, SQLIntegrityConstraintViolationException
    {
        Word wordObj = null;
